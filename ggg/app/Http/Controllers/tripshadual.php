...
class tripshadual extends Controller
{
    public function AddjournySchaduals(schadualTrip $request)
    {
        ...
        $scheduleTripData = $request->only([
            ...
            'destination_en','destination_ar', 'descripyion_en',
            'descripyion_ar', 'fly_time', 'fly_date',
        ...
        foreach ($request->file() as $field => $file) {
            $scheduleTripData[$field] = $file->store('photos', 'public');
        }
