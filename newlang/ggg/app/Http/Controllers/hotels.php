...
foreach ($photos as $photo) {
    ...
    if ($hotels->hasFile($photo)) {
        $hotelPhotoPath = md5(uniqid(rand(), true)) . '.' . $photoFile->getClientOriginalExtension();
        $photoFile->move(public_path('photos'), $hotelPhotoPath);
        $hotelPhotoPath = 'photos/' . $hotelPhotoPath;
    }
