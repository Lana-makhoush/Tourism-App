...
Route::middleware('ChangLanguage')->group(function () {
    Route::get('contients', [filters::class, 'GetContients']);//done//Admin
    Route::get('seasons', [filters::class, 'GetSeasons']);//done//Admin
    Route::get('sections', [filters::class, 'GetSections']);//done//Admin
    Route::get('typeTicket', [filters::class, 'GetTypeTicket']);//done//Admin
});
//Hotels
Route::middleware('ChangLanguage')->group(function () {
...
//تجريب
    Route::get('DisplayTripsDependonFORConstTrip/{id1}/{id2}/{id3}/{id4}', [filters::class, 'DisplayTripsDependonFORConstTrip']);//done//user
    Route::get('DisplayTripsDependonForOptionalTrip/{id1}/{id2}/{id3}/{id4}', [filters::class, 'DisplayTripsDependonForOptionalTrip']);//done//user
    Route::get('DisplayTripsDependonFoTicket/{id1}/{id2}', [filters::class, 'DisplayTripsDependonFoTicket']);//done//user

//عرض حجوزات المستخدم
Route::get('reservationsForUser/{userID}', [Reservations::class, 'reservationsForUser']);//user//done
Route::get('getconstchosen/{id}',[consTjourny::class,'getconstchosen']);
Route::get('getoptionaltripschosen/{id}',[optionaljourny::class,'getoptionaltripschosen']);
Route::get('getticketchosen/{id}',[ticket::class,'getticketchosen']);
